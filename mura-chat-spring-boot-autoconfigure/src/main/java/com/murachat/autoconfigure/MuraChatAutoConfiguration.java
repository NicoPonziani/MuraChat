...
import com.murachat.autoconfigure.observability.ObservabilityConfiguration;
import com.murachat.autoconfigure.rag.VectorStoreConfiguration;
...
@Import({ChatClientConfiguration.class, VirtualThreadsAdvisorConfiguration.class, ObservabilityConfiguration.class, VectorStoreConfiguration.class})
